<?php
    ...
    if(isset(($_POST['update']))){
        ...
        $update->update($email, $role, $status, $password, $id);
        echo "<script>alert('Your details was updated successfully')</script>";
    }
...
<body class="">
    ...
    <main class="container mt-5">
        <h3 class="font-weight-bold text-center">Edit Nanny</h3>
